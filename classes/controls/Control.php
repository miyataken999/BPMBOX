...
class EditControl
{
	...
	function __construct($field, $pageObject, $id, $connection)
	{
		...
		$this->searchOptions[CONTAINS] = "次の値を含む";
		$this->searchOptions[EQUALS] = "次の値と等しい";
		$this->searchOptions[STARTS_WITH] = "次の値で始まる";
		$this->searchOptions[MORE_THAN] = "次の値より大きい";
		$this->searchOptions[LESS_THAN] = "次の値より小さい";
		$this->searchOptions[BETWEEN] = "次の二つの値の間";
		$this->searchOptions[EMPTY_SEARCH] = "空(Empty)";
		$this->searchOptions[NOT_CONTAINS] = "次の値を含まない";
		$this->searchOptions[NOT_EQUALS] = "等しくない";
		$this->searchOptions[NOT_STARTS_WITH] = "先頭にない";
		$this->searchOptions[NOT_MORE_THAN] = "次の値より大きくない";
		$this->searchOptions[NOT_LESS_THAN] = "次の値より少なくない";
		$this->searchOptions[NOT_BETWEEN] = "次の値の間に無い";
		$this->searchOptions[NOT_EMPTY] = "空でない";
