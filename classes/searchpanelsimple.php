...
class SearchPanelSimple extends SearchPanel {
	...
	{	
		...
		$searchOpt_mess = ($searchPanelAttrs['srchOptShowStatus'] ? "検索オプションを隠す" : "検索オプションを表示する");
	...
	function DisplaySearchPanel()
	{
		...
		$showHideOpt_mess = $this->srchPanelAttrs['ctrlTypeComboStatus'] ? "オプションの非表示" : "オプションの表示";		
